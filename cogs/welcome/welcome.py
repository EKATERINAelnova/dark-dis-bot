    ...
    def create_welcome_embed(
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                f"• Пройди верификацию и дождись подтверждения модератора\n"
                f"• После получения роли участника открой `/прогресс`\n"
                f"• Загляни в `/профиль`, `/достижения` и `/ритуал`\n"
                f"• Присоединяйся к EVENT, DUEL и CLOSE\n\n"
                f"> *«We don't return. "
                f"We rebuild.»*"
            ),
            color=EDEN_GOLD,
